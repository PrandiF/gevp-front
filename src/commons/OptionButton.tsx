...
function OptionButton({ text, url }: ButtonProps) {
  return (
    <a
      href={url}
      className="relative flex items-center px-6 py-3 overflow-hidden font-medium transition-all bg-celeste rounded-md group xl:h-[70px] md:h-[50px] h-[50px] xl:w-[300px] md:w-[270px] w-[250px]"
    >
